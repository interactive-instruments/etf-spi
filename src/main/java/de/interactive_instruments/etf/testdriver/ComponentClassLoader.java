 ...
 *
 * This CL does not search for the loaded class by calling the parent class loader (default Java RT ClassLoader behaviour) but tries to load the class as Jar from its children URL ClassLoader first.
 *
 * Detailed search order: - Check if parent already loaded Class - Try loading from Jars - Try loading from dependency ClassLoaders - Try loading from parent
 *
