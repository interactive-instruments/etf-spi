 ...
 * - Check if parent already loaded Class
 * - Try loading from Jars
...
final class ComponentClassLoader extends ClassLoader implements Closeable {
	 ...
	 *
	 * @param jar jar path
	 * @param disallowedJarNames names of jar files that will not be loaded
	 */
	 ...
	 *
	 * @param dir directory containing JARs
	 * @throws IOException
	 */
